//
//  BKPhotoBrowserDemoViewController.m
//  BKProjectFramework
//
//  Created by zhaolin on 2018/10/18.
...
@interface BKPhotoBrowserDemoViewController ()<BKPhotoBrowserDelegate>
{
    NSArray * imageArr;
}
@end

@implementation BKPhotoBrowserDemoViewController
...
-(void)photoBrowser:(BKPhotoBrowser *)photoBrowser qrCodeContent:(NSString*)qrCodeContent photoBrowserNav:(UINavigationController *)photoBrowserNav
{
    ...
    BKPhotoBrowserDemoViewController * secondVC = [[BKPhotoBrowserDemoViewController alloc]init];
