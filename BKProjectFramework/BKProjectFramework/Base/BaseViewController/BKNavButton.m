    ...
    if (_image && [_title length] == 0) {
        ...
        switch (_imagePosition) {
            case BKImagePositionLeft:
            {
                ...
                self.width = CGRectGetMaxX(_titleRect) + space;
            }
                break;
            ...
            case BKImagePositionRight:
            {
                ...
                self.width = CGRectGetMaxX(_imageRect) + space;
            }
                break;
